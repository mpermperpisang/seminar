    ...
    <body>	
		...
		<table border=0 width=100% align="left">	
			<tr>
				<td colspan="6">
					<p align="justify">
						<b><font size="+1">ADD OR EDIT PRESENTATION ROOM</font></b>
						<?php			
							$link=koneksi_db();	
				...
				<td colspan="10">
					...
					?>
						...
						<tr>
							...
							$res2=mysql_query("SELECT distinct ruangan,nama_bidang_kajian from cms_jadwal,cms_paper,cms_abstrak,cms_bidang_kajian
					...
					<form method="post" action="update_ruangan.php">
						...
						<tr>
							<td align="right">
								<input type='image' title='Add Room' src='../gambar/add.png' width='25'>
								<?php
							echo "
