...
<html>
    ...
    <body>	
		...
		<table border=0 width=100% align="left">	
								...
								<?php
									if(isset($_POST['keyword']))
									{
										...
										$sql=$sql." and $fieldcari like '%$keyword%' 
											order by cms_panitia.kategori_panitia asc";
									}
								?>
				</td>
			</tr>
			...
			<tr>
				<td colspan="7">
					<a href="add_panitia.php"><img src="../gambar/add.png" width="25" title="Add Committee"></a>
					&nbsp;
					<a href="../download_panitia.php"><img src="../gambar/print.jpg" width="25" title="Print Committee"></a>
				</td>
				<td>
						<?php
							$res = mysql_query($sql);
