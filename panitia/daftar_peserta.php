...
<html>
    ...
    <body>	
		...
		<table border=0 width=100% align="left">	
				...
				<td colspan="7">
					<p align="justify">
						...
						<?php			
							...
							and cms_tahun.bil_tahun='$id_tahun'";
						?>	
				</td>			
				<td align="right"><br>
								<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
								<input type="hidden" name="bil_tahun" value="<?php echo $id_tahun ?>">
								...
								<?php
									if(isset($_POST['keyword']))
									{
										...
										$sql=$sql." and $fieldcari like '%$keyword%'  
											order by cms_peserta.id_pengguna desc";
									}
								?>
				</td>
			</tr>
			...
			<tr>
				<td colspan="7">
					<?php $bil_tahun=$_REQUEST['bil_tahun']; ?>
					<?php echo "<a target='_blank' href=../download_peserta_2.php?bil_tahun=$bil_tahun>"; ?><img src="../gambar/print.jpg" width="25" title="Print Presenter Absent"></a>
					&nbsp;
					<?php echo "<a target='_blank' href=../download_daftar_peserta_2.php?bil_tahun=$bil_tahun>"; ?><img src="../gambar/print.jpg" width="25" title="Print Participant List"></a>
				</td>
				<td>
						<?php
							$res = mysql_query($sql);
						...
						<?php
								while($select_result = mysql_fetch_array($res))
								{
									...
									<tr>
										...
										<td>$level</td>
										<td>$ket</td>
										<form method=\"POST\" action=\"edit_peserta.php?id=$id\">
										<td align='center'>
											<input type=\"hidden\" value=\"$id\" name=\"id\"><center>
											<input type='image' title='Edit Participant' src='../gambar/edit.png' width='25'>
										</td>
										</form>";
									if ($id_kategori_pengguna=='1')
									{
