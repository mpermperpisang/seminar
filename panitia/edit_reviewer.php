    ...
    <body>	
		...
		<table border=0 width=100% align="left">	
			<tr>
				<td>
					<p align="justify">
						<b><font size="+1">EDIT REVIEWER</font></b>
						<br>
						...
						<?php			
							...
							if($banyakrecord>0)
							{
								...
								echo"
								<form action='update_reviewer.php' method='POST'>
							...
							<?php
								...
								echo"
									...
									<tr>
										<td align='right'>
												<input type='image' src='../gambar/update.jpg' width='25' title='Update Reviewer'>
										</td>
								</form>
								<form action='reviewer.php'>
										<td align='left'>
