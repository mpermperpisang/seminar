...
<p class="message"><h2>LOGIN UNSUCCESSFUL</h2></p>
...
<form name="loading" id="loading">
	...
	?>
    <p>&nbsp;</p>
	<br /><br /><br />You don't have an access for login because your account has been nonactivated<br /><br />
    <p><span class="style4">Call Administrator for more info</span></p><br />
    <p><span class="style4">Click "<a href="index.php">Research Seminar</a>" for return to home</span></p>
    <p>
      <label></label>
  </form>
