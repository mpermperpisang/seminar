...
<p class="message"><h2>WELCOME TO RESEARCH SEMINAR WEBSITE</h2></p>
...
<form name="loading" id="loading">
    ...
    <p><span class="style4">
		<?php 				
			...
			$select5 = "INSERT INTO cms_rektorat(id_pengguna)
			...
			$select_query5 = mysql_query($select5);
				...
				if(isset($_SESSION['login_member']))
				{
					...
					{
						echo "
						<td align='left'>You Are Login As Participant</td>
						";
					}
					else if(($_SESSION['login_member']==true)&&($_SESSION['aktif']=="2"))
					{
						echo "
						<td align='left'>You Are Login As Administrator</td>
						";
					}
					else if(($_SESSION['login_member']==true)&&($_SESSION['aktif']=="3"))
					{
						echo "
						<td align='left'>You Are Login As Committee</td>
						";
					}
					else if(($_SESSION['login_member']==true)&&($_SESSION['aktif']=="4"))
					{
						echo "
						<td align='left'>You Are Login As Reviewer</td>
						";
					}
					else if(($_SESSION['login_member']==true)&&($_SESSION['aktif']=="5"))
					{
						echo "
						<td align='left'>You Are Login As Headship</td>
						";
					}
				} 
		?>
