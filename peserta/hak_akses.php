    ...
    <body>	
		...
		<table border=0 width=100% align="left">	
			<tr>
				<td>
					<p align="justify">
						<b><h3>FORBIDDEN ACCESS OF PARTICIPANT PAGE</h3></b>
						...
						<table border="0" align="center" cellspacing="25" cellpadding="5">
							...
							<?php
								...
								{
							?>
								<td><a href="../panitia/index.php"><img src="../gambar/panitia.png" width="100" title="Return to committee page"></a><br>You're Login as Committee</td>
							<?php
								}
								else if(($_SESSION['login_member']==true)&& 
								  ($_SESSION['aktif']=="4"))
