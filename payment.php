...
<a class='share_facebook' href='https://www.facebook.com/sharer.php?u=http://seminar-penelitian.com/payment.php' onclick='window.open(this.href,"_blank","height=430,width=640");return false;' rel='nofollow' title='Share to Facebook'>Facebook</a>
<a class='share_google' href='https://plus.google.com/share?url=http://seminar-penelitian.com/payment.php' onclick='window.open(this.href,"_blank","height=600,width=530");return false;' rel='nofollow' title='Share to Google+'>Google+</a>
<a class='share_twitter' href='https://twitter.com/share?url=http://seminar-penelitian.com/payment.php' onclick='window.open(this.href,"_blank","height=430,width=640");return false;' rel='nofollow' title='Share to Twitter'>Twitter</a>
</div>
				<?php
								$sql = "select * from cms_postingan
								where kategori_posting='13'";
								$res = mysql_query($sql);
								while($select_result = mysql_fetch_array($res))
								{								
