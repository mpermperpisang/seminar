    ...
    <body>	
		...
		<table border=0 width=100% align="left">	
			<tr>
				<td colspan="7">
					<p align="justify">
						<b><font size="+1">HEADSHIP LIST</font></b>
						<?php
							$link=koneksi_db();			
							$sql = "select * from cms_pengguna,cms_pimpinan
							where cms_pengguna.id_pengguna=cms_pimpinan.id_pengguna";
						?>	
				</td>			
				<td align="right"><br>
			...
			<tr>
				<td colspan="7">
					<a href="add_pimpinan.php"><img src="../gambar/add.png" width="25" title="Add Headship"></a>
				</td>
				<td>
						<?php
							$res = mysql_query($sql);
							...
							{
						?>
								<div align="right">There are <b><?php echo $banyakrecord;?></b> data of headship</div>
				</td>
			</tr>
		</table>
		<table align="center" border="0" cellpadding="5" width=100%>
					<tr bgcolor="#CCCCCC">
						...
						<?php 
							...
							{
						?>
								<div align="right">Data of headship not found</div>	
						<?php
							};
						?>
						<?php
								while($select_result = mysql_fetch_array($res))
								{
									...
									if ($id_kategori_pengguna=='5')
									{
									echo "<form method=\"POST\" action=\"unpublish_pimpinan.php?id=$id\">
										<td align='center'>
											<input type=\"hidden\" value=\"$id\" name=\"id\"><center>
											<input type='image' title='Nonactive Headship' src='../gambar/unpublish.png' width='25'>
										</td>
										</form>";
									}
									else
									{
									echo "<form method=\"POST\" action=\"publish_pimpinan.php?id=$id\">
										<td align='center'>
											<input type=\"hidden\" value=\"$id\" name=\"id\"><center>
											<input type='image' title='Active Headship' src='../gambar/publish.jpg' width='25'>
										</td>
										</form>";
									}
									echo "<form method=\"POST\" action=\"delete_pimpinan.php?id=$id\">
										<td align='center'>
											<input type=\"hidden\" value=\"$id\" name=\"id\"><center>
											<input type='image' title='Delete Headship' src='../gambar/delete.png' width='25' onclick='return confirmSubmit()'>
										</td>
										</form>
									</tr>";
								}
