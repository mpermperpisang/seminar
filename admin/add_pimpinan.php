    ...
    <body onLoad="self.focus();document.form1.username.focus()">	
		...
		<table border=0 width=100% align="left">	
			<tr>
				<td>
					<p align="justify">
						<b><font size="+1">ADD HEADSHIP</font></b>
						<br>
		...
		<br>
			<form action="insert_pimpinan.php" method="post" name="form1">
			<table border=0 width=30% align="left">
				...
				<tr align="center">
					<td align="right">
						<input type="image" src="../gambar/add.png" width="25" name="kirim" title="Add Headship">
		</form>
					</td>
