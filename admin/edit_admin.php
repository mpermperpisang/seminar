    ...
    <body>	
		...
		<table border=0 width=100% align="left">	
			<tr>
				<td>
					<p align="justify">
						<b><font size="+1">EDIT ADMINISTRATOR</font></b>
						<br>
						...
						<?php			
							...
							if($banyakrecord>0)
							{
								while($select_result = mysql_fetch_array($res))
								{
									...
									$level_admin=$select_result['level_admin'] ;
								}
								echo"
							...
							<?php
								...
								echo"
									...
									<tr>
										<td align='right'>
												<input type='image' src='../gambar/update.jpg' width='25' title='Update Admin'>
										</td>
								</form>
